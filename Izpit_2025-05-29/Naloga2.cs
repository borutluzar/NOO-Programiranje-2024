namespace Izpit_2025_05_29
{
    ...
    /// NALOGA 2:
    /// 
    /// Za znano založbo pripravljamo aplikacijo za vodenje knjig.
    /// 
    ...
    /// in Lokacija (lokacijo police v založbi). 
    /// Dodajte še funkcijo, ki vrne najstarejšo knjigo na polici,
    /// in funkcijo, ki vrne skupno ceno vseh knjig na polici.                      [9 točk]
    /// 
    /// V funkciji ResitevNaloge ustvarite eno instanco razreda KnjiznaPolica 
    /// in na njen seznam knjig dodajte tri knjige različnih tipov. 
    /// Na zaslon s pomočjo klica ustrezne funkcije izpišite 
    /// lastnosti najstarejše knjige na polici in število knjig, 
    /// ki so bile izdane po letu 2010.                                             [5 točk]
    /// </summary>
